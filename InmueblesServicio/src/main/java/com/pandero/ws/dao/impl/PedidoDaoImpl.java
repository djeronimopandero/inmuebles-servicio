...
public class PedidoDaoImpl implements PedidoDao {
	...
	public void agregarPedidoInversionSAF(PedidoInversionSAF pedidoInversionSAF) throws Exception {
		...
		call.addDeclaredParameter(new SqlParameter("@InmuebleInversionHipotecado", Types.INTEGER));
		...
		parameters.addValue("@InmuebleInversionHipotecado", pedidoInversionSAF.getInmuebleInversionHipotecado());
	...
	public void registrarInmuebleInversionSAF(Inversion inversion, String usuarioID) throws Exception {
		...
		parameters.addValue("@PartidaRegistral", inversion.getPartidaRegistral());
		parameters.addValue("@UsuarioID", usuarioID);
	...
	private static final class ContratoPedidoMapper implements RowMapper<Contrato>{
		public Contrato mapRow(ResultSet rs, int rowNum) throws SQLException {			
			...
			p.setSituacionContrato(rs.getString("SituacionContratoID"));
			return p;		    
		}
	}
