...
public class GarantiaDaoImpl implements GarantiaDao {
	...
	@Override
	public Map<String,Object> editarGarantiaSAFV2(Garantia garantia, String usuarioId) throws Exception {
		SimpleJdbcCall call = new SimpleJdbcCall(jdbcTemplate);
		call.withProcedureName("dbo.USP_LOG_Inmb_EditarGarantia_V2");
		call.withoutProcedureColumnMetaDataAccess();	
		...
		call.addDeclaredParameter(new SqlParameter("@UsuarioID", Types.INTEGER));
		call.addDeclaredParameter(new SqlOutParameter("@importeFinal", Types.DECIMAL));
		call.addDeclaredParameter(new SqlOutParameter("@nroCuotas", Types.INTEGER));
		...
		Map<String,Object> out = call.execute(parameters);
		return out;
	}
