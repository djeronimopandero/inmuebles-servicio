	...
	public void generarCartaObservacion(String inversionId, String usuarioSAFId) throws Exception {
		...
		if(!StringUtils.isEmpty(inversionId)){
			 ...
			 if(null!=list){
				...
				Parametro parametro4=new Parametro("text_4", StringUtils.isEmpty(pic.getTipoInmuebleNom())?"":pic.getTipoInmuebleNom());//tipo inmbueble
				Parametro parametro5=new Parametro("text_5", pic.getImporteInversion()==null?"":String.valueOf(pic.getImporteInversion()));//Importe
